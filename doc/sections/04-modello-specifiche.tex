...
\begin{equation}
E[S_k] = \pi \cdot E[S_{k, SR}] + (1-\pi) \cdot E[S_i]
\end{equation}
...
E[S_i] = 10\ min
\end{equation}
con $i \in \lbrace 1, 2, \dots, k-1, k+1, \dots, M\rbrace$.
...
E[S_{k,SR}] = 2 \cdot E[S_{i,UO}] = \frac{680}{41} \simeq 16.5853658\ min
\end{cases}
\end{equation}
