...
\author{A. Chillotti\thanks{\texttt{alessandro.chillotti@outlook.it}}
\and 
C. Cuffaro\thanks{\texttt{cristiano.cuffaro@outlook.com}} 
\and 
S. Tiberi\thanks{\texttt{simone.tiberi.98@gmail.com}}
}
...
\newcommand{\uo}{\textbf{Unica Operazione}}
\newcommand{\pp}{\textbf{Pagamenti \& Prelievi}}
\newcommand{\sr}{\textbf{Spedizioni \& Ritiri}}

\begin{document}
\maketitle
\tableofcontents

\input{sections/01-presentazione}
\input{sections/02-obiettivi}
\input{sections/03-modello-concettuale}
