...
\usepackage[font={small,sl}, justification=centering]{caption}
\usepackage[font={small,sl}, justification=centering]{subcaption}
...
\input{chapters/01-presentazione}
\input{chapters/02-obiettivi}
\input{chapters/03-modello-concettuale}
\input{chapters/04-modello-specifiche}
\input{chapters/05-modello-computazionale}
\input{chapters/06-verifica}
\input{chapters/07-validazione}
\input{chapters/08-esperimenti-simulazione}
\input{chapters/09-miglioria}
