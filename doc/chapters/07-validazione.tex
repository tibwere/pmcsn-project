...
Il metodo adottato è stato quello delle batch means con parametri $(b,k) = (2250, 64)$ e periodo d'osservazione $\tau = 480 \cdot 300$\footnote{Si è assunto che mediamente un anno lavorativo sia composto da 300 giorni.}.
...
\begin{equation} 
\bar{d}_g = \sum_{i = 1}^4 p_{g,i}\cdot \bar{d}_{g,i} = (8.26 \pm 0.96)\ min
\end{equation}
\item Il tempo di risposta globale ottenuto è pari a:
\begin{equation}
\bar{w}_g = \sum_{i = 1}^4 p_{g,i}\cdot \bar{w}_{g,i} = (23.35 \pm 1.08)\ min
\end{equation}
\end{itemize}
...
\section{Blocco del flusso degli arrivi di tipo \uo{} e \pp{}}
...
\item Il tempo d'attesa globale ottenuto è pari a:
\begin{equation} 
\bar{d}_d = p_{d,1}\cdot \bar{d}_{d,1} + p_{d,2}\cdot \bar{d}_{d,2} = (210.04 \pm 51.51)\ min
\end{equation}
\item Il tempo di risposta globale ottenuto è pari a:
\begin{equation}
\bar{w}_g = \sum_{i = 1}^4 p_{g,i}\cdot \bar{w}_{g,i} = (234.77 \pm 51.81)\ min
\end{equation}
\end{itemize}
