...
\item Nel caso in cui l'evento corrente sia un completamento di un cliente afferente ad una classe $c$, il servente che si è appena liberato processa, se presente, il primo cliente in coda seguendo l'ordine di priorità, replicando i punti (a), (b) e (c) del bullet dedicato all'arrivo di un nuovo cliente.
\end{itemize}
