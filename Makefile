...
LIBS 			= -lm
DEPS 			= $(INCLUDE_DIR)/rngs.h $(INCLUDE_DIR)/rvgs.h $(INCLUDE_DIR)/rvms.h $(INCLUDE_DIR)/utils.h
BIN_OBJ 		= $(OBJ_DIR)/simul.o
DEPS_OBJ 		= $(OBJ_DIR)/rngs.o $(OBJ_DIR)/rvgs.o $(OBJ_DIR)/rvms.o $(OBJ_DIR)/utils.o
